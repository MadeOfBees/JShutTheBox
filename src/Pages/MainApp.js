...
export default function MainApp() {
    ...
    return (
        <div >
            {totalPlayers ? <DrawBoard playerTotal={totalPlayers} refreshNum={refreshNum} /> : <Box sx={{ flexGrow: 2 }} style={{ marginTop: '20%' }}><Grid container spacing={2} justifyContent="center" alignItems="center" style={{ marginTop: '28%' }}><Button variant="contained" style={{ display: 'block', width: "200px", height:"200PX", fontSize:"40px"}} sx={{lineHeight: 'normal'}} onClick={handleOpen}>Open The Box</Button></Grid></Box>}
